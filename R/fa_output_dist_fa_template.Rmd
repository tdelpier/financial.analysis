...
params:
  ...
  page_statecat:        TRUE
  page_millages:        TRUE
  page_stu_transfers:   TRUE 
  page_econ_disad:      TRUE
  page_transfers:       TRUE
  page_transfers_alt:   FALSE
  page_methods:         TRUE
---
...
```{r,  child = if(params$page_transfers_alt == TRUE){"C:/Users/Tdelpier/vault/projects/financial.analysis/R/FA_Page_Transfers-Alt.Rmd"}}
```
...
```{r, child = if(params$page_stu_transfers == TRUE){"C:/Users/Tdelpier/vault/projects/financial.analysis/R/FA_Page_Student-Transfers.Rmd"}}
```


```{r, child = if(params$page_econ_disad == TRUE){"C:/Users/Tdelpier/vault/projects/financial.analysis/R/FA_Page_Econ-Disad.Rmd"}}
```
