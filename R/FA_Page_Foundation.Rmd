...
"The [foundation allowance](https://www.house.mi.gov/hfa/PDF/Alpha/Fiscal_Brief_Basics_of_the_Foundation_Allowance_FY24_Update_Nov23.pdf) 
 provides districts with the majority of their operating funding. These dollars are distributed on a per pupil basis. Although the per pupil foundation allowance is set by the state, local non-homestead property taxes pay for a portion."}`
...
FA_Data_District %>%
  ...
  flextable_custom_theme(title = "Table 15. Per Pupil Foundation Allowance")
...
FA_Data_District %>%
  ...
  labs(title = "Figure 7. Foundation Allowance",
       x = "Fiscal Year",
       y = "")
...
FA_Data_District %>%
  ...
  flextable_custom_theme(title = "Table 16. Total Foundation Allowance Revenue Estimate") 
...
FA_Data_District %>%
  ...
  scale_x_continuous(breaks = seq(1990, 2100, by = 1) )+
  scale_y_continuous(labels = number_format(big.mark = ","))+
  labs(title = "Figure 8. Total Estimated Foundation Allowance Revenue",
       x = "Fiscal Year",
       y = "")
...
FA_Data_District %>%
 ...
 set_header_labels(FY = "Fiscal Year",
  ...
  flextable_custom_theme(title = "Table 15. Out-of-Formula Foundation Allowance")
