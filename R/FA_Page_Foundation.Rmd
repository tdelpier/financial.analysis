...
FA_Data_District %>%
  ...
  flextable_custom_theme(title = "Table x. Per Pupil Foundation Allowance")
...
FA_Data_District %>%
  ...
  labs(title = "Figure x. Foundation Allowance",
       x = "Fiscal Year",
       y = "")
...
FA_Data_District %>%
  ...
  flextable_custom_theme(title = "Table x. Total Foundation Allowance Revenue Estimate") 
...
FA_Data_District %>%
  ...
  scale_x_continuous(breaks = seq(1990, 2100, by = 1) )+
  scale_y_continuous(labels = number_format(big.mark = ","))+
  labs(title = "Figure x. Total Estimated Foundation Allowance Revenue",
       x = "Fiscal Year",
       y = "")
...
FA_Data_District %>%
 ...
 set_header_labels(FY = "Fiscal Year",
  ...
  flextable_custom_theme(title = "Table x. Out-of-Formula Foundation Allowance")
