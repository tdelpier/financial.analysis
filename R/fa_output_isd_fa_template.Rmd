...
FA_Data_ISD %>% 
  ...
  colformat_double(j = c("sev", "sev.chg"), big.mark = ",", )%>%
...
FA_Data_ISD %>% 
  ...
  select(FY, sev, milloper, millage.rev.oper,  millspeced, millage.rev.se, millvoced, millage.rev.voc, enhancemnt, millage.rev.rem) %>% 
  flextable() %>% 
  set_header_labels(FY = "Fiscal Year",
                    sev = "Taxable Value (Thousands)",
  ...
  flextable_custom_theme(title = "Millage Rates and Revenue")
