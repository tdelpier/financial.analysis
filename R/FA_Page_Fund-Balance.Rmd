...
FA_Data_District %>%
  ...
  flextable_custom_theme(title = "Table 7. General Fund Balance")
...
FA_Data_District %>% 
  ...
  labs(title = "Figure 6. General Fund Balance % Expenditure",
       x = "Fiscal Year",
       y = "") 
...
FA_Data_District %>% 
  ...
  colformat_double(big.mark = ",",
    ...
    colformat_num(j = "FY",
                big.mark = "") %>%
  flextable_custom_theme(title = "Table 8. General Fund Balance by Balance Class")
...
FA_Data_District %>% 
  ...
  colformat_num(j = "Fiscal Year",
                big.mark = "") %>% 
  flextable_custom_theme(title = "Table 9. Other Fund Balancesv by Fiscal Year")
...
FA_Data_District %>% 
  ...
  colformat_double(big.mark = ",",
                   digits = 0) %>% 
  flextable_custom_theme(title = paste0("Table 10. Other Fund Balances by Balance Class, FY ", 
                                   fiscal.year-1))
