...
FA_Data_District %>%
  ...
  bg(j = "fid.e.total.xtrans", bg = mea_red_light, part = "all") %>% 
   ...
   flextable_custom_theme(title = "Table x. General Fund Revenue and Expenditure")
...
FA_Data_District %>% 
  ...
  labs(title = "Figure x. <span style='color: #00A651'> Revenue</span> and <span style='color: #C2002F'>Expenditure</span>",
       x = "Fiscal Year",
       y = "")+
