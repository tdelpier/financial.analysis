...
FA_Data_District %>%
  ...
  set_header_labels(FY = "Fiscal Year",
   ...
   colformat_double(j = "fid.rev.expended", suffix = "%") %>% 
    bg(j = "fid.r.total.audit", bg = "#C2FFDF", part = "all") %>%
  bg(j = "fid.e.total.xtrans", bg = "#fad1db", part = "all") %>% 
...
Note: revenue, expenditure, and surplus/deficit refer to the district's "General Fund." 
