...
State aid membership is the blended enrollment count used by the state to determine funding. This metric is the sum of 90% of the October count and 10% from the previous school year's February count. This "membership" is defined in state law in [MCL 388.1606(4)](https://www.legislature.mi.gov/Laws/MCL?objectName=MCL-388-1606). Regulatory guidance is produced each year through MDE's annual [Pupil Accounting Manual](https://www.michigan.gov/mde/services/financial-management/state-aid/publications/pupil-accounting-manual-pam) (PAM).
...
FA_Data_District %>%
  ...
  bg(j = "cy.d.pupilcnt", bg = "#d1e8fa", part = "all") %>%
