...
if(No_FID_Avalible == 0 ){
  ...
  FA_Data_District %>%
    ...
    # color coding totals
    bg(i = ~ Rev_Source == "Total Revenue", bg = "#d1e8fa",  part = "body") %>% 
    bg(i = ~ Rev_Source == "Total less Stimulus and UAAL", bg = "#C2FFDF",  part = "body") %>% 
